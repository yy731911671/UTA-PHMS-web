<template>
  <div class="all-container">
    ...
    <div class="chartBox">
      <div>
        <div class="title">Doctor's level:</div>
        <ve-ring :data="chartData" width="300px" style="background: #FFFFFF"
                 height="380px"
      ...
      <div style="margin-top:30px">
        <img height="300px" style="border-radius: 10px" src="../../../../static/commu3.png">
      </div>
    </div>
  </div>
</template>
